...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("C:\\Users\\COZMET\\Desktop\\todoPyQt\\portfolio.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.menuE_Achat = QtWidgets.QMenu(self.menubar)
        self.menuE_Achat.setObjectName("menuE_Achat")
        ...
        self.actionENT_Commande = QtWidgets.QAction(MainWindow)
        self.actionENT_Commande.setObjectName("actionENT_Commande")
        ...
        self.menuE_Achat.addAction(self.actionENT_Commande)
        ...
        self.menubar.addAction(self.menuE_Achat.menuAction())
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.menuE_Achat.setTitle(_translate("MainWindow", "E_Achat"))
        ...
        self.actionENT_Commande.setText(_translate("MainWindow", "ENT Commande"))
