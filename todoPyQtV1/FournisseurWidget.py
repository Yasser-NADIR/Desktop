...
class Ui_FounisseurValideWidget(object):
    def setupUi(self, FounisseurValideWidget):
        ...
        self.pushButtonModifier = QtWidgets.QPushButton(self.layoutWidget)
        self.pushButtonModifier.setObjectName("pushButtonModifier")
        self.verticalLayout.addWidget(self.pushButtonModifier)
        self.pushButtonSupprimer = QtWidgets.QPushButton(self.layoutWidget)
    ...
    def retranslateUi(self, FounisseurValideWidget):
        ...
        self.pushButtonModifier.setText(_translate("FounisseurValideWidget", "Modifier"))
        self.pushButtonSupprimer.setText(_translate("FounisseurValideWidget", "Supprimer"))
